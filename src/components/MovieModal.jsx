...
const MovieModal = ({ movie, onClose, onPlay }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/95 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="w-full max-w-6xl bg-gradient-to-br from-gray-900/90 via-black/95 to-purple-950/90 rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl border border-purple-800/30 backdrop-blur-xl">
              ...
              <div className="flex-1 space-y-3 sm:space-y-4 text-center lg:text-left">
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 sm:gap-3 lg:gap-4">
                  ...
                  <div className="bg-gradient-to-r from-purple-600 to-pink-600 px-3 py-2 rounded-full text-white text-xs sm:text-sm font-bold uppercase tracking-wide flex items-center space-x-1">
                    ...
                    <span>{movie.mediaType || 'movie'}</span>
                  </div>
                </div>
            ...
            {activeTab === 'cast' && (
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
                  {[...Array(8)].map((_, i) => (
                    <div key={i} className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-xl lg:rounded-2xl p-3 sm:p-4 border border-purple-800/30 hover:border-purple-500/50 transition-all duration-300 backdrop-blur-sm">
                      <div className="w-full h-24 sm:h-28 lg:h-32 bg-gradient-to-br from-purple-600/20 to-blue-600/20 rounded-lg lg:rounded-xl mb-3 flex items-center justify-center">
                        <Users className="w-6 h-6 sm:w-8 sm:h-8 text-gray-400" />
                      </div>
                      <h4 className="text-white font-semibold text-xs sm:text-sm">Cast Member {i + 1}</h4>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    {movie.mediaType === 'tv' && details.number_of_seasons && (
                      <div className="bg-gradient-to-r from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-xl p-4 border border-purple-800/30">
                        <h4 className="text-white font-semibold mb-2 flex items-center text-sm sm:text-base">
